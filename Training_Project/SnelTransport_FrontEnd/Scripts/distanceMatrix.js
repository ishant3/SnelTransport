...
$(document).ready(function () {
    ...
    $("#btnInsert").click(function () {
        ...
        $.ajax({
            ...
            url: "http://172.16.1.186/Service_Database_Connection/Service.svc/rest/InsertDistance_Data",
            type: "POST",
            //async: false,
...
$(document).ready(function () {
    ...
    $("#btnNonDeliveryOptimalAddress").click(function () {
        ...
        for (var i = 0; i <= array4.length - 1; i++) {
            var address = array4[i];
            $("#tblNonDeliveryAddress").append("<tr><td>" + address + "</td></tr>");
