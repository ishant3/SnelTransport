...
namespace Service_Database_Connection
{
    ...
    public interface IService
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "Get_Config_Optimal_Route")]
        IEnumerable<ConfigOptimalRoute> GetOptimalRoute_Config();
        ...
        [OperationContract]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, UriTemplate = "InsertArticle")]
